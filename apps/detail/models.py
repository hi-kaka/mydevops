...
class ConnectionInfo(models.Model):
    ...
    # 自动化任务外键
    conn_grp1 = models.ForeignKey('GroupInfo', related_name='conn_grp1', verbose_name=u'组一外键名', null=True)
    conn_grp2 = models.ForeignKey('GroupInfo', related_name='conn_grp2', verbose_name=u'组二外键名', null=True)
    conn_grp3 = models.ForeignKey('GroupInfo', related_name='conn_grp3', verbose_name=u'组三外键名', null=True)
    conn_grp4 = models.ForeignKey('GroupInfo', related_name='conn_grp4', verbose_name=u'组四外键名', null=True)
    conn_grp5 = models.ForeignKey('GroupInfo', related_name='conn_grp5', verbose_name=u'组五外键名', null=True)
    conn_grp6 = models.ForeignKey('GroupInfo', related_name='conn_grp6', verbose_name=u'组六外键名', null=True)
    conn_grp7 = models.ForeignKey('GroupInfo', related_name='conn_grp7', verbose_name=u'组七外键名', null=True)
    conn_grp8 = models.ForeignKey('GroupInfo', related_name='conn_grp8', verbose_name=u'组八外键名', null=True)
    conn_grp9 = models.ForeignKey('GroupInfo', related_name='conn_grp9', verbose_name=u'组九外键名', null=True)
    conn_grp10 = models.ForeignKey('GroupInfo', related_name='conn_grp10', verbose_name=u'组十外键名', null=True)
...
class GroupInfo(models.Model):
    group_name = models.CharField(max_length=80, verbose_name=u'组名', null=False)
    group_detail = models.CharField(max_length=256, default='', verbose_name=u'组信息描述', null=True)

    class Meta:
        verbose_name = u'Ansible自动化任务分组信息表'
        verbose_name_plural = verbose_name
        db_table = 'groupinfo'
