...
class ANSRunner(object):
    ...
    def get_playbook_result(self):
        ...
        #     self.results_raw['changed'][host] = result._result
...
if __name__ == '__main__':
    #以列表list的形式传入inventory资源，前提是list中的dict对象需要先组装至符合格式，才能调用传入组成inventory中的host，其实就是resource中的hosts的值
    # resource = [
    ...
    # Ansible Adhoc
    rbt.run_model(host_list=['778da6afsdwf','nginx01'],module_name='shell',module_args="ls /tmp")
